...
2. In the NetScaler GUI, go to **Traffic Management > Load Balancing > Services > Add**, and specify the name, the IP address, and set the protocol as **HTTP**. Select **OK** to finish.
3. Confirm that the service is operational:
4. Repeat step two for any additional servers.
5. Go to **Traffic Management > Load Balancing > Virtual Servers >** and click **Add**. Specify the name and select **SSL** as the Protocol. Then, enter the public IP address. Select **OK** to finish.
