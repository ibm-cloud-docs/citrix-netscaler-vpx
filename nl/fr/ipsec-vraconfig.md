...
# Configuration du dispositif Virtual Router Appliance 
{: #configuring-vra}

Maintenant que votre VPX Citrix est configuré, vous devez configurer le dispositif IBM Virtual Router Appliance (VRA). Pour ce faire, utilisez la syntaxe suivante :
