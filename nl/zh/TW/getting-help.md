...
* 如果您有 Citrix NetScaler VPX 的相關技術問題，請將問題張貼在 [Stack Overflow](https://stackoverflow.com/search?q=citrix-vpx+ibm-bluemix)，並使用 "citrix-vpx" 和 "ibm-bluemix" 來標記問題。
* 若為服務及開始使用指示的相關問題，請使用 [IBM developerWorks dW Answers](https://developer.ibm.com/answers/topics/citrix-vpx.html?smartspace=bluemix) 討論區。請包含 "citrix-vpx" 和 "bluemix" 標籤。
