...
# 取得 {{site.data.keyword.vpx_full}} 的協助及支援
{: #getting-help-and-support-for-citrix-netscaler-vpx}

如果您在使用 {{site.data.keyword.vpx_full}} 時有問題或疑問，可以搜尋資訊或透過下列其中一個討論區提問來取得協助。您也可以開立支援問題單。

使用討論區提問時，請標記您的問題，以便 IBM© Cloud 開發團隊能看到它。

* 如果您有 {{site.data.keyword.vpx_full}} 的相關技術問題，請將問題張貼在 [Stack Overflow](https://stackoverflow.com/search?q=citrix-vpx+ibm-cloud)，並使用 "citrix-vpx" 和 "ibm-cloud" 來標記問題。
