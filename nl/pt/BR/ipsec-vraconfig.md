...
# Configurando o Virtual Router Appliance
{: #configuring-vra}

Agora que seu Citrix VPX está configurado, é necessário configurar o IBM Virtual Router Appliance (VRA). Para isso, use a seguinte sintaxe:
